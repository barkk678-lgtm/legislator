...
_EXPAND_SYSTEM = (
    ...
    '["מחסור","חוסר","חסר","תקנ","מצבת","כוח אדם","גיוס"].\n'
    "- היבט 2, כשיש: **הגוף או התחום** - משטרה, חינוך, בריאות. **צר ככל "
    "האפשר**: 'ניתוחים' -> [\"ניתוח\"], ולא רופאים או בריאות בכלל. "
    "'במשטרת ישראל' -> "
    '["משטר","שוטר","שיטור","מג\"ב","משמר הגבול"]. '
    "כשהתופעה היא התחום עצמו ('תחבורה ציבורית') - היבט אחד לשניהם.\n"
    "- היבט 3, רק אם הנושא נוקב במקום: היישובים והאזורים שבו. "
    "'במפרץ חיפה' -> "
