...
תיבה, חתימות...), אבל אם תבנית *מבנית* (כמו {{ח:קטע1}}/{{ח:קטע3}},
שקיימות בפועל בחוק העונשין ועדיין לא מטופלות - ראו TASKS.md משימה 7)
מדולגת באותה צורה, מתקבל עץ שנראה תקין אבל חסרים בו סעיפים/רמות
מבנה שלמות. הבדיקות כאן תופסות בדיוק את זה, ברעש, לפני שהתוצאה
נכתבת ל-DB.
"""
