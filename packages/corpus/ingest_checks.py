...
_KNOWN_STRUCTURAL_TEMPLATES = {
    ...
    "ח:קטע3",
    "ח:קטע4",
    "ח:קטע5",  # זהה מילה-במילה ל-קטע4 בוויקי, תמיד רמת-מבנה (ברק,
    # 2026-09-16 - ראו wikitext_parser.py _STRUCTURAL_LEVEL_SUB_SIMAN).
    "ח:סעיף",
    "ח:סעיף*",
    "ח:ת",
    "ח:תת",
...
_KNOWN_BENIGN_SKIP_TEMPLATES = {
    ...
    "צבע גופן",  # עיטור טקסט (צבע גופן) - נבדק בפועל (2026-09-14, חוק
    # התכנון והבניה/תזכיר חוק): כשהוא מופיע כשורה עליונה בפני עצמה
    # (לא מקונן בתוך ארגומנט תבנית אחרת) הוא תמיד בתוך קופסת ח:מבוא -
    # אותה סיבה בדיוק כמו ח:הערה למעלה, לא לוגיקה חדשה.
}
