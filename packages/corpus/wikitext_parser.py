...
def parse_wikitext(
    ...
    for raw_line in text.splitlines():
        ...
        # תבנית לא-מוכרת ברמה העליונה (כותרת/מאגר/תיבה/חתימות/וכו') - מדולגת.
        # ראו TASKS.md משימה 3: metadata כמו {{ח:כותרת}}/{{ח:תיבה}} אינה
        # נדרשת להגדרת הסיום (מבנה העץ), ומתועדת כפער פתוח.
