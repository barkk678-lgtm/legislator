...
# מתארות נכון את מה שהמערכת מפיקה. אם וכאשר ייבנה מסלול ליצירת חוק
# חדש (PROJECT_CONTEXT.md מזכיר אותו כמסלול נפרד עתידי), הוא יצטרך
# בדיקות משלו - לא הרפיה של אלה.
