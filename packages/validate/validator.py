...
_DRAFT_SKIP_REASONS = {
    1: "דורשת את עץ החוק המתוקן; מסמך שהועלה אינו מביא איתו את החוק שהוא מתקן",
    ...
    12: "הבדיקה ידועה כחלקית (נכשלה על 4 מתוך 40; סדר סעיפי הסיום בפועל רחב "
        "מזה שהיא מכירה) - מושבתת עד שתתוקן",
...
def validate_draft(bill: Bill) -> list[Finding]:
    ...
    **בדיקות 4 ו-7 מותנות בסוג ההצעה** (א6): הן שואלות שאלה שיש לה
    ...
    runners = {3: _check_3, 4: _check_4, 5: _check_5, 6: _check_6,
               7: _check_7, 9: _check_9, 11: _check_11}
    out: list[Finding] = []
